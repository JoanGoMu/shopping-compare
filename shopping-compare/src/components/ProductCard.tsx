    ...
    >
      ...
      <div className="aspect-[3/4] bg-cream overflow-hidden relative">
        ...
        {product.price_check_failed && (
          <div className="absolute bottom-0 inset-x-0 bg-black/55 px-2 py-1.5 flex items-center gap-1.5 z-10">
            ...
            <span className="text-[10px] text-white/90 leading-tight">Price unavailable - visit page</span>
          </div>
        )}
